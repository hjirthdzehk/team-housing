...
var ProfileViewModel = function(profileData) {
    ...
    self.personName = ko.observable('Anton');
    self.flats = ko.observableArray([{
        flatNo: ko.observable(23),
        meters: ko.observableArray([{
            title: 'huj',
            value: 123,
            unit: 'cbm'
        }])
    ...
    self.personName(profileData.personName);
    self.flats(_.map(profileData.metersByFlat, function (meters, flat) {
        return {
